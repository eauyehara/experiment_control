...
# -*- coding: utf-8 -*-
"""
Update a simple plot of pressure measured by the KJL KPDR900 vacuum gauge.
"""
...
from kjl_client import get_pressure

Npts = 500
wait_sec = 0.1
sample_time_sec = 0.9 # estimate of time taken by server to return value
rescale = True
...
p = pg.PlotItem()
p.setLogMode(y=True,x=None)                                                         # turn on log scaling for y axis
#p = pg.PlotWidget()
p.setWindowTitle('KJL KPDR900 Pressure Data')
...
ylab = p.setLabel('left',text='pressure',units='Torr')
...
curve0 = p.plot(time_array,data0,pen=(255,165,0),name='pressure')
...
def update():
    ...
    title_str = r'<font color="white">Cryo Probe Station Pressure</font>, ' + fps_str
